...
import br.com.bancodigital.service.NaiveTransferService;
...
/**
 * BankSimulation is the main executable to demonstrate race conditions.
 * SRP: Coordinate and execute the multi-threaded simulation run.
 */
public class BankSimulation {
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Starting Digital Bank Concurrency Simulation (Naive Implementation)...");
        ...
        TransferService service = new NaiveTransferService();
    ...
    private static void runSimulation(TransferService service, Account accountA, Account accountB) {
        ...
        for (int i = 0; i < threads; i++) {
            ...
            executor.submit(new TransferTask(service, accountA, accountB, direction, transfersPerThread, startLatch, finishLatch));
        }
    ...
    private static class TransferTask implements Runnable {
        ...
        public TransferTask(TransferService s, Account a, Account b, boolean f, int c, CountDownLatch sl, CountDownLatch fl) {
            this.service = s;
            this.accountA = a;
            this.accountB = b;
            this.forward = f;
